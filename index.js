import{a as d,S as y,N as b,P as w}from"./assets/vendor-DeWL0fjv.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))i(t);new MutationObserver(t=>{for(const s of t)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function n(t){const s={};return t.integrity&&(s.integrity=t.integrity),t.referrerPolicy&&(s.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?s.credentials="include":t.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(t){if(t.ep)return;t.ep=!0;const s=n(t);fetch(t.href,s)}})();async function f(){const e=document.querySelectorAll(".learn-more"),a=document.querySelector("[data-artist-loader]");e.forEach(n=>{n.addEventListener("click",async()=>{a.hidden=!1;const i=n.dataset.id;try{const s=(await d.get(`/artists/${i}/albums`)).data,o=document.querySelector(".artist-modal"),r=document.querySelector(".artist-info");r.innerHTML=k(s),o.classList.remove("hidden-artist-modal"),document.body.classList.toggle("no-scroll")}catch(t){const s=`Error while executing the request: ${t}`;console.error(s),alert(`❌${s}`)}finally{a.hidden=!0}})})}const c=document.querySelector(".artist-modal"),L=document.querySelector(".close-artist-modal");function u(){c.classList.add("hidden-artist-modal"),document.body.classList.remove("no-scroll")}L.addEventListener("click",u);c.addEventListener("click",e=>{e.target===c&&u()});document.addEventListener("keydown",e=>{e.key==="Escape"&&!c.classList.contains("hidden-artist-modal")&&u()});function k(e){var a,n;return`
  ...
  `}const $="/Falcons-2/assets/icons-CtQiyP8Q.svg";async function g(e=1,a=8){return(await d.get("/artists",{params:{page:e,limit:a}})).data}function E(e){var a;return`
    <li class="artist-card">
      ...
      <button class="learn-more" data-id="${e._id}">
        ...
        <svg class="icon-artists-learn-more" width="8" height="24">
          <use xlink:href="${$}#icon-artist-svg-1"></use>
        </svg>
      </button>
    </li>
